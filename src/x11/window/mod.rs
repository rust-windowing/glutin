...
unsafe extern "C" fn x_error_callback(_: *mut ffi::Display, event: *const ffi::XErrorEvent) -> libc::c_int {
        ...
        loop {
            ...
            match xev.kind() {
                ...
                ffi::ButtonPress | ffi::ButtonRelease => {
                    ...
                    let button = match event.button as libc::c_int {
...
impl Window {
    pub fn new(builder: BuilderAttribs) -> Result<Window, CreationError> {
        ...
        let fb_config = unsafe {
            ...
            ffi::XFree(fb as *mut libc::c_void);
            preferred_fb
        };
        ...
        let mut visual_infos: ffi::glx::types::XVisualInfo = unsafe {
            ...
            ffi::XFree(vi as *mut libc::c_void);
            vi_copy
        };
        ...
        let wm_delete_window = unsafe {
            let mut wm_delete_window = with_c_str("WM_DELETE_WINDOW", |delete_window|
                ffi::XInternAtom(display, delete_window, ffi::False)
            );
    ...
    fn get_geometry(&self) -> Option<(i32, i32, u32, u32, u32)> {
        unsafe {
            ...
            if ffi::XGetGeometry(self.x.display, self.x.window,
                ...
                &mut border, &mut depth) == ffi::False
            {
                return None;
            }
