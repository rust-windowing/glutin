...
mod wayland {
   ...
   #[derive(Clone)]
   pub struct PollEventsIterator<'a> { _a: &'a () }
   #[derive(Clone)]
   pub struct WaitEventsIterator<'a> { _a: &'a () }
...
pub fn get_available_monitors() -> VecDeque<MonitorID> {
    match *BACKEND {
        Backend::Wayland => panic!(), /*wayland::get_available_monitors()
                                .into_iter()
...
pub fn get_primary_monitor() -> MonitorID {
    match *BACKEND {
        Backend::Wayland => panic!(), //MonitorID::Wayland(wayland::get_primary_monitor()),
...
impl<'a> Iterator for PollEventsIterator<'a> {
    ...
    fn next(&mut self) -> Option<Event> {
        match self {
            ...
            &mut PollEventsIterator::Wayland(_) => panic!()
...
impl<'a> Iterator for WaitEventsIterator<'a> {
    ...
    fn next(&mut self) -> Option<Event> {
        match self {
            ...
            &mut WaitEventsIterator::Wayland(_) => panic!()
